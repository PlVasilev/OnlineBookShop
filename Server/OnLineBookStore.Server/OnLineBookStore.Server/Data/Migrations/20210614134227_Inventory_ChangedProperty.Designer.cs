...
namespace OnLineBookStore.Server.Data.Migrations
{
    ...
    [Migration("20210614134227_Inventory_ChangedProperty")]
    partial class Inventory_ChangedProperty
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnLineBookStore.Server.Data.Models.Inventory", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OnLineBookStore.Server.Data.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OnLineBookStore.Server.Data.Models.Cart", b =>
                {
                    b.HasOne("OnLineBookStore.Server.Data.Models.User", "User")
                        .WithOne("Cart")
                        .HasForeignKey("OnLineBookStore.Server.Data.Models.Cart", "UserId")
